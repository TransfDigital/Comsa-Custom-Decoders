/**
 * Payload Decoder for Multiple Platforms (Chirpstack v4 & v3, TTN) adapted for CSER IoT Platform. Rev 26/03/2025 - MRV
 *
...
function milesightDeviceDecode(bytes) {
    ...
    if (["motorPosition", "motorRange"].every(includesKey, Object.keys(decoded))){
        decoded.valveOpening = {
            "value": (1 - decoded.motorPosition.value / decoded.motorRange.value) * 100,
            "unit": "%",
            "name": "Obertura valvula"           
        };
    }
