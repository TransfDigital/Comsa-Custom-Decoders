...
function milesightDeviceDecode(bytes) {
    ...
    if (["motorPosition", "motorRange"].every(includesKey, Object.keys(decoded))) {
        decoded.valveOpening = (1 - decoded.motorPosition / decoded.motorRange) * 100;
    }
